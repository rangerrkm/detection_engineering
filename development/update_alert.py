...
url = "https://b697f46fd0154e35936b554aa634df51.us-central1.gcp.cloud.es.io:9243/api/detection_engine/rules?rule_id="
...
data = ""
for root, dirs, files in os.walk("C:\Scripts\Python\converted_detections\\trouble"):
    for file in files:
